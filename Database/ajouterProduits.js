...
function ajouterProduits(db) {
  ...
  db.execute(
    "INSERT INTO Produits VALUES (2, 'NVIDIA GeForce RTX 2080 Ti', 2269.00, 'https://c1.neweggimages.com/ProductImage/A6V6_131892134822443207UHmuOK7nLc.jpg', 8, 'Carte graphique NVIDIA GeForce RTX 2080 Ti Founders Edition 11 Go GDDR6. Vitesse d'horloge de base à 1635 MHz.');"
  );
  db.execute(
    "INSERT INTO Produits VALUES (3, 'MSI Gaming RTX 3080 10GB', 1299.00, 'https://c1.neweggimages.com/ProductImage/14-137-677-V07.jpg', 12, 'Carte graphique MSI Gaming GeForce RTX 3080 GDDR6 PCI Express 4.0 pour des cartes mères ATX. Vitesse d'horloge maximal à 1830 MHz.');"
  );
  db.execute(
    "INSERT INTO Produits VALUES (4, 'GIGABYTE Gaming OC GeForce RTX 3060 12GB', 639.00, 'https://c1.neweggimages.com/ProductImageCompressAll60/14-932-433-V10.jpg', 27, 'Carte vidéo GIGABYTE Gaming OC RTX 3060 PCI 4.0 Express. Vitesse d'horloge maximal à 1837 MHz. Carte performante et silencieuse, parfait pour le gaming.');"
  );
  db.execute(
  ...
  db.execute(
    "INSERT INTO Produits VALUES (6, 'MSI MPG Z490 Gaming Edge', 189.99, 'https://c1.neweggimages.com/ProductImage/13-144-302-V01.jpg', 85, 'Carte mère ATX MSI Z490 Gaming Edge LGA 1200 SATA 6Gb/s. Compatible avec la 10e et 11e génération d'Intel Core.');"
  );
  db.execute(
